-- Update trigger to call the edge function which has access to the secret
      ...
      IF FOUND THEN
        ...
        IF current_registered_count < course_rec.max_participants THEN
          ...
          IF FOUND THEN
            ...
            -- Call edge function to send webhook (it has access to the secret)
            edge_function_url := 'https://vdpeyaphtsbrhygupfbc.supabase.co/functions/v1/notify-waitlist-promotion';
            ...
            BEGIN
              PERFORM net.http_post(
                ...
                headers := jsonb_build_object(
                  ...
                  'Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZkcGV5YXBodHNicmh5Z3VwZmJjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM2MzA1NTQsImV4cCI6MjA2OTIwNjU1NH0.di1zDFbMIYpX-FNsSshaf4q-OMW8SpLqYM5SToltcCI'
                ),
                body := jsonb_build_object('registration_id', waitlist_rec.id)::TEXT
              );
