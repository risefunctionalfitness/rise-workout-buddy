-- Update the can_user_register_for_course function to prevent duplicate registrations for same course title on same day
CREATE OR REPLACE FUNCTION public.can_user_register_for_course(
  user_id_param uuid, 
...
BEGIN
    ...
    -- NEW: Check if user is already registered for same course title on same day
