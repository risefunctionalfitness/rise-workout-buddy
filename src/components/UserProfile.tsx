...
import { LogOut, Dumbbell, Target, Moon, Sun, RotateCcw, Eye, EyeOff, AlertTriangle, Pencil, Trophy } from "lucide-react"
  ...
  return (
    <div className="fixed inset-0 bg-background z-50 overflow-auto">
      <div className="max-w-2xl mx-auto p-4 pb-24">
        ...
        {/* Einstellungen - kombiniert Anzeige, Benachrichtigungen und Leaderboard */}
        <Card className="border-primary/20 mb-4">
          <CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Anzeige</h3>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={handleLeaderboardVisibilityToggle}
                />
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gray-300 dark:bg-gray-600 rounded-full flex items-center justify-center">
                    <svg className="w-5 h-5 text-gray-600 dark:text-gray-200 fill-current" viewBox="0 0 24 24">
              ...
              {/* WhatsApp Section - aktuell deaktiviert (Business Cloud) */}
              {WHATSAPP_ENABLED && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
