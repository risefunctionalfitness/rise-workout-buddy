...
export default function Admin() {
  ...
  const [activePage, setActivePage] = useState<'home' | 'members' | 'courses' | 'templates' | 'news' | 'codes' | 'credits' | 'workouts' | 'challenges' | 'leaderboard' | 'emails' | 'risk-radar'>('home');
  ...
  return (
    <div className="min-h-screen bg-background">
      <RiseHeader 
        ...
        onPageChange={(page) => setActivePage(page as 'home' | 'members' | 'courses' | 'templates' | 'news' | 'codes' | 'credits' | 'workouts' | 'challenges' | 'leaderboard' | 'emails' | 'risk-radar')}
      />
